        ...
        <div className='rounded-lg mx-auto cursor-pointer reviewCard px-6 md:px-6 sm:px-4 py-4 md:space-y-3.5 sm:space-y-2.5 space-y-3.5 transition-all max-w-[23rem] shadow-sm duration-300'>
            <header className='flex items-center space-x-3'>
                ...
                <div className=''>
                    ...
                    {/* Title */}
                    <span className='text-xs font-normal'>Customer</span>
                </div>
            </header>

            {/* Review Text */}
            <p className='text-sm text-justify  sm:text-xs md:text-sm tracking-normal'> Belanja lewat aplikasi ini sangat praktis. Saya bisa mendapatkan semua yang saya butuhkan dengan cepat dan mudah. Bahan-bahan yang saya terima selalu dalam kondisi terbaik. Luar biasa!.</p>
